export const experience = [
  {
    ...
    achievements: [
      ...
      "Led sprint planning, technical design discussions and code reviews while mentoring developers.",
    ],
  },
...

  {
    ...
    year: "2016",
    color: "bg-red-500",
    projects: ["Docusign Document Management System"],
    achievements: [
      "Worked as full-stack developer using React.js and .NET Core.",
      "Developed document management platform for Life Sciences domain.",
    ],
  },
];
